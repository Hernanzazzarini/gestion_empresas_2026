...
const navItems = [
  ...
  { to: '/logistica/contenedores',   label: 'Control Contenedores', icon: '🚛', modulo: 'contenedores' },
  { to: '/logistica/stock',          label: 'Control de Stock',     icon: '📦', modulo: 'stock' },
  { to: '/logistica/reporte-stock',  label: 'Reporte de Stock',     icon: '📋', modulo: 'stock' },
